/*
Cache: jquery-lazy, thickbox, dt-main, dt-language, dt-main-op-jquery, dt-plugins, waypoints, vc_carousel_js, vc_transition_bootstrap_js, qfe_composer_front_js, wc-cart-fragments, jquery-cookie, bitcommerce, jquery-blockui, wc-cart, wc-country-select, jquery-form, jquery-migrate, jquery-core
*/
/* jquery-core: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
...
/* jquery-migrate: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* jquery-form: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-includes/js/jquery/jquery.form.min.js) */
/*!
 * jQuery Form Plugin
...
/* wc-country-select: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/country-select.min.js) */
...
/* wc-cart: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/cart.min.js) */
jQuery(function(a){return"undefined"==typeof wc_cart_params?!1:(a(document).on("click",".shipping-calculator-button",function(){return a(".shipping-calculator-form").slideToggle("slow"),!1}).on("change","select.shipping_method, input[name^=shipping_method]",function(){var b=[];a("form:visible select.shipping_method,form:visible  input[name^=shipping_method][type=radio]:checked,form:visible  input[name^=shipping_method][type=hidden]").each(function(){b[a(this).data("index")]=a(this).val()}),a("div.cart_totals").block({message:null,overlayCSS:{background:"#fff url("+wc_cart_params.ajax_loader_url+") no-repeat center",backgroundSize:"16px 16px",opacity:.6}});var c={action:"bitcommerce_update_shipping_method",security:wc_cart_params.update_shipping_method_nonce,shipping_method:b};a.post(wc_cart_params.ajax_url,c,function(b){a("div.cart_totals").replaceWith(b),a("body").trigger("updated_shipping_method")})}),void a(".shipping-calculator-form").hide())});;

/* jquery-blockui: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
/* bitcommerce: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/bitcommerce.min.js) */
		...
		$(".address-item .select-address").unbind().bind("click",function(){
			...
			$.post("/admin/admin-ajax.php",{action:"update_web_address","index":index},
				function(rlt) {
					rlt = $.parseJSON(rlt);
					if(rlt.status=="1"){
						$("[name='mobiel_address_id']").val(index);
						//刷新
						if(rlt.data){
...
/* jquery-cookie: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-cookie/jquery.cookie.min.js) */
/*!
...
/* wc-cart-fragments: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/cart-fragments.min.js) */
...
/* qfe_composer_front_js: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
/* vc_transition_bootstrap_js: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+function ($) { "use strict";
...
/* vc_carousel_js: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* dt-plugins: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (https://5cdd3aa5c46ea.t73.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function(){
...
/* dt-main: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
...
/* thickbox: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* jquery-lazy: (https://5cdd3aa5c46ea.t73.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
